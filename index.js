...
const uri = "mongodb+srv://varunagarwal:varun@cluster0.vvdiuhc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    //insert art to the db :post method
  ...
  //get all arts from the database
    ...
    app.patch("/art/:id",async(req,res)=>{
        ...
        //update
        const result=await  artCollections.updateOne(filter,updateDoc,options);
        res.send(result);
    })
    //delete a art item
